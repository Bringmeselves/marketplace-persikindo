...
<div class="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8 space-y-10 text-gray-800">
    ...
    <div class="bg-white shadow-lg rounded-2xl p-6">
        <form action="{{ route('user.pembayaran.store', $checkout->id) }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="flex justify-between items-center font-bold text-lg text-gray-900 border-t pt-4">
